...
<%
    ...
    AgendaItem agendaItem = (AgendaItem) request.getAttribute("agendaItem");
%>
...
<main class="px-3 py-5 sm:px-40 md:px-60 lg:px-80">
    ...
    <p class="mb-5 text-slate-600">Veuillez remplir les champs
        suivants pour modifier le sujet de discussion</p>

    <form action="update" method="post">
        <div class="mb-6 flex flex-col gap-5">
            <input hidden="hidden" name="id" value="<%= agendaItem.getId() %>">
            <input hidden="hidden" name="meetingId" value="<%= agendaItem.getMeeting().getId() %>">
            ...
            <div>
                ...
                <input type="text" id="description" name="description"
                       value="<%= agendaItem.getDescription() %>"
            ...
            <div>
                ...
                <select id="presenterId" name="presenterId"
                    ...
                    %>
                    <option
                            <%= agendaItem.getPresenter().getId() == employee.getId() ? "selected" : "" %>
        ...
        <div class="flex justify-end">
            <a href="<%= request.getContextPath() + "/agendas?meetingId=" +  agendaItem.getMeeting().getId() %>"
