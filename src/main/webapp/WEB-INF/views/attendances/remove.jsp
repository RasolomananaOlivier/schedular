...
<head>
    ...
    <title>Supprimer des invités</title>
</head>
<body class="py-4 px-5">
<jsp:include page="/WEB-INF/components/header.jsp"/>
<h1 class="mb-4 text-3xl font-extrabold text-gray-900 md:text-5xl lg:text-6xl">Supprimer des invités.</h1>
...
<div class="top-5 relative overflow-x-auto border-t border-r border-l">
    <form action="<%=request.getContextPath() + "/attendances/delete?meetingId=" + meeting.getId()%>" method="post">
