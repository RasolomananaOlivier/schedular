...
<div class="top-5 relative overflow-x-auto border-t border-r border-l">
    <table class="w-full text-left text-sm text-gray-500 rtl:text-right">
        ...
        <tr>
            ...
            <th scope="col" class="px-6 py-3">Commence à</th>
            <th scope="col" class="px-6 py-3">Se termine à</th>
        ...
        <tr class="border-b bg-white hover:bg-gray-50">
            ...
            <td class="px-6 py-4">
                <%= DateFormater.format(meeting.getStartTime())  %>
            </td>
            <td class="px-6 py-4">
                <%=  DateFormater.formatToHour(meeting.getStartTime()) %>
            </td>
            <td class="px-6 py-4">
                <%= DateFormater.formatToHour(meeting.getEndTime()) %>
            </td>
            <td class="px-6 py-4">
